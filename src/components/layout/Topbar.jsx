...
export default function Topbar() {
  ...
  const navLoading = useAppStore(s => s.navLoading);
  ...
  return (
    <div className="topbar">
      ...
      <div className="topbar-brand"><b>MF Tracker</b> <span>v2.1</span></div>
      <div className="topbar-right">
        <span className="nav-status">{navStatus}</span>
        <button className="refresh-btn" onClick={fetchNAV} disabled={navLoading}>{navLoading?'⌛ Loading...':'↻ Refresh NAV'}</button>
